...
const Footer = () => {
    return (
        <div className='mt-24'>
            <footer className="footer bg-base-300 items-center p-4 text-neutral-content px-12 mt-6">
