...
//                 <h2> I'm Sumi Akter.</h2>
//                 <p className=" text-3xl font-bold text-secondary uppercase" data-aos="fade-left">-Junior Web Developer</p>
//                 {/* <p >I'm a creative and passionate Junior-Web developer from Bangladesh. </p> */}
//             </div>
//         </div>

//         // <div className="grid lg:grid-cols-2 my-24 " >
//         //     <div className='rounded-tr-3xl px-12  rounded-bl-3xl  bg-black '>
...
//         //         <h2 className="text-5xl font-bold uppercase animate-charcter " data-aos="fade-down"> I'm Sumi Akter.</h2>
//         //         <p className=" text-3xl font-bold text-secondary uppercase" data-aos="fade-left">-Junior Web Developer</p>
//         //         <p className=' ' data-aos="fade-left">I'm a creative and passionate Junior-Web developer from Bangladesh. Being a friendly person and eager to learn new technologies. I'm comfortable in English and a quick responder.</p>
//         //         <div >
//         //             <NavLink to='/about'>
